...
db.once("open", async () => {
  ...
  const trainer = await Trainer.insertMany([
    ...
    },
    {
      name: "Eddie Coan",
      description:
        "World respected power-lifter. Guaranteed to get you strong as an ox.",
      image: "placeholder",
      category: [categories[0]._id],
    ...
    },
    {
      name: "Alex Restrepo",
      description:
        "Here to help you carry a tune inside and outside of a bucket!",
      image: "placeholder",
      category: [categories[2]._id],
    ...
    },
    {
      ...
      description:
        "While blue might be my favorite color, let me teach you ways without talking your ear off!",
      image: "placeholder",
      category: [categories[2]._id],
